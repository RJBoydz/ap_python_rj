...
# int() for solving numbers with decimal on a calculator website
# str() to convert object in a code into string, if want you can use
# str to capitalize your words
# bool() for a history and fact website
