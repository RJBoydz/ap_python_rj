def preference():
    ...
    if movie == 'action':
        print('Avengers' 'Mission impossible' 'Godzila vs Kong')
        if movie == 'Avengers':
        ...
        if movie == 'Five nights at Freddy':
